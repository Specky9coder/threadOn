...
import 'package:threadon/pages/User_Followers1.dart';
import 'package:threadon/utils/ModalProgressHUD.dart';
import 'package:http/http.dart' as http;
import 'package:threadon/utils/SharedPreferencesHelper.dart';

class Followers_Tab extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => followers_tab();
}

class followers_tab extends State<Followers_Tab> {
  ...
  getFollowingData() async {
    ...
    QuerySnapshot eventsQuery =
        await ref.where("follower_id", isEqualTo: user_id).getDocuments();
    ...
    if (eventsQuery.documents.isEmpty) {
      ...
      eventsQuery.documents.forEach((doc) async {
        ...
        folloeList.add(FollowModel(doc['date'], doc['follower_id'],
  ...
  Widget build(BuildContext context) {
    ...
    itemHeight = (size.height - kToolbarHeight - 42);
    ...
    return Scaffold(
      body: ModalProgressHUD(
        child : folloeList.length == 0 ? Showmsg() : Container(        
        child: mobilesize
                            ...
                            children: <Widget>[
                              Expanded(
                                ...
                                child: new GestureDetector(
                                    child: Seller_following_list[position]
                                        .Profile_picture ==
                                        ""
                                        ? new Row(
                                        mainAxisAlignment:
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Container(
                                        ...
                                        alignment: Alignment.topLeft,
                                        child: Text(
                                          Seller_following_list[position].Name,
                                          style: TextStyle(
                                              fontSize: 17.0,
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        Seller_following_list[position].Country,
                                        style: TextStyle(
                                            fontSize: 15.0,
    ...
    return Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('No Followers', style: TextStyle(fontSize: 20.0),),
