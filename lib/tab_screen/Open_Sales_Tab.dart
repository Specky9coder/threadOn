...
class Open_Sale_Tab extends StatefulWidget{
  @override
  State<StatefulWidget> createState() =>opensale_tab();

}


class opensale_tab extends State<Open_Sale_Tab>{
            ...
            children: <Widget>[
              Container(
                width: width,
                  ...
                  height: 30.0,
                  color: Colors.green,
                  child: Text('Live',style: TextStyle(color: Colors.white,fontSize: 18.0),) ) ,
  ...
  Widget _gridView() {
    return GridView.count(
      ...
      children: item_list.map((Item) => ItemList(item: Item),
      )
          .toList(),
    );
  }
