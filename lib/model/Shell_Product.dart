class Shell_Product_Model {
  ...
  Shell_Product_Model.map(dynamic obj) {
    this.any_sign_wear = obj['Any_sign_wear'];
    this.category = obj['category'];
    this.category_id = obj['category_id'];
    this.country = obj['country'];
    this.date = obj['date'].toDate();
  ...
  Map<String, dynamic> toMap() {
    ...
    map['brand_new'] = brand_new;

    return map;
  }

  Shell_Product_Model.fromMap(Map<String, dynamic> map) {
    ...
    // this.item_picture = map['item_picture'].cast<String>();
    ...
    // this.packing_type = map['packing_type'];
