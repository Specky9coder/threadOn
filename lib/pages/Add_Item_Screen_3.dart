...
class Add_Item_3 extends StatefulWidget{

  String appbar_name;

  Add_Item_3({Key key, this.appbar_name}) : super(key: key);
  @override
  State<StatefulWidget> createState() =>add_item_3(appbar_name);

}


class add_item_3 extends State<Add_Item_3>{
            ...
            itemBuilder: (context, position) {
              return  GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    Is_Sub_Cat_id = '${sub_categoryList[position].Sub_category_id}';
