...
import 'package:threadon/tab_screen/Favorite_Tab.dart';
...
class Favorite_Screen extends StatefulWidget {
  ...
  Favorite_Screen({Key key, this.appbar_name}) : super(key: key);

  @override
  State<StatefulWidget> createState() => favorite(appbar_name);
}

class favorite extends State<Favorite_Screen> with SingleTickerProviderStateMixin  {
  String appbar_name;
  TabController tabController;

  String user_id = '';
  String Carttotal = "0";
  favorite(this.appbar_name);
...
//        automaticallyImplyLeading: false,
      ...
      body: getTabBarView(<Widget>[new Favorite_Tab(), new ShareList_Tab()]));
