...
class User_Following1 extends StatefulWidget {
  final Login_Modle item;

  const User_Following1({@required this.item});

  @override
  State<StatefulWidget> createState() => new user_following1(
        item,
      );
// TODO: implement createState
}

class user_following1 extends State<User_Following1> {
  final Login_Modle item;
...
/*------------------------------------------favourite--------------------------------------*/
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                child: ListView.builder(
                                    itemCount: userProductImage.length,
  ...
  getFollowing(String Seller_id) async {
    ...
    if (eventsQuery.documents.isEmpty) {
      ...
      eventsQuery.documents.forEach((doc) async {
        follower_id = doc['following_id'];
        followModel.add(FollowModel(doc['date'].toDate(), doc['follower_id'],
            doc['following_id'], doc['id'].toString(), doc['status']));
