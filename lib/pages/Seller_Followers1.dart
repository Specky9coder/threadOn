...
class Seller_Followers1 extends StatefulWidget {
  final Login_Modle item;
  final Login_Modle user_item;

  const Seller_Followers1({@required this.item, this.user_item});

  @override
  State<StatefulWidget> createState() => new seller_Followers1(item, user_item);
// TODO: implement createState
}

class seller_Followers1 extends State<Seller_Followers1> {
  final Login_Modle item;
  ...
  seller_Followers1(this.item, this.user_item);

  String user_id = '', Share_id = '', seller_id = '';
  final myController = TextEditingController();
  List<Share> shareList;
  List<Share> shareList1 = new List();
  bool favourite = false;
  String Flag1 = "", productId = "";
  final GlobalKey<ScaffoldState> scaffolds = new GlobalKey<ScaffoldState>();
...
/*------------------------------------------favourite--------------------------------------*/
  ...
  Future getData() async {
    ...
    QuerySnapshot eventsQuery = await ref
        ...
        .where('following_id', isEqualTo: seller_id)
        .getDocuments();
  ...
  void showInSnackBar(String value) {
    scaffolds.currentState.showSnackBar(SnackBar(content: Text(value)));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ModalProgressHUD(        
        // child: userProductImage .length == 0? new Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                ...
                                child: userProductImage.length == 0
                                    ? new Container(
                                      
                                    )
                                    : ListView.builder(
                                        itemCount: userProductImage
                                            .length, //userProductImage.length,
