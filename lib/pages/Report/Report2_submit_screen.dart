...
class Report2_Submitscreen extends StatefulWidget {
  String title;

  Report2_Submitscreen({Key key, this.title}) : super(key: key);

  @override
  State<StatefulWidget> createState() => new report2_submit(title);
// TODO: implement createState

}

class report2_submit extends State<Report2_Submitscreen> {
  String title;
  String user_id = '', product_id = '';
  FirebaseFirestoreService db = new FirebaseFirestoreService();
  StreamSubscription<QuerySnapshot> noteSub;

  report2_submit(this.title);
  final myController = TextEditingController();

  bool checkBoxValue = false, checkBoxValue1 = false, checkBoxValue2 = false;
  String Carttotal = "0";
  ...
  void handleSubmit() async {
    String submit_value =
        value + ',' + value1 + ',' + value2 + ',' + myController.text;
    ...
    if (submit_value == "" || submit_value == null || submit_value == ",,,,,") {
      ...
      noteSub?.cancel();
      db
          .createReport('', user_id, product_id, '0', DateTime.now(),
              submit_value, '', '')
          .then((_) {
                  ...
                  Container(
                    child: new Row(
                      ...
                      children: <Widget>[
                        new Checkbox(
                            ...
                            onChanged: (bool newValue) {
                              setState(() {
                                ...
                                if (newValue == true) {
                                  value = 'Retail price is too high';
                                } else {
                                  value = '';
                                }
                                print(checkBoxValue);
                        ...
                        new Text('Retail price is too high'),
                      ],
                    ),
                  ),
                  Container(
                    child: new Row(
                      ...
                      children: <Widget>[
                        new Checkbox(
                            ...
                            onChanged: (bool newValue) {
                              setState(() {
                                ...
                                if (newValue == true) {
                                  value1 = 'Selling price is too high';
                                } else {
                                  value1 = '';
                                }
                        ...
                        new Text('Selling price is too high'),
                      ],
                    ),
                  ),
                  Container(
