...
class GridItemDetails1 extends StatefulWidget {
  final Shell_Product_Model item;
  final int exitflag;

  const GridItemDetails1({this.item, this.exitflag});

  @override
  State<StatefulWidget> createState() =>
      new griditemdetail1(this.item, this.exitflag);
// TODO: implement createState
}

class griditemdetail1 extends State<GridItemDetails1> {
  ...
  final Shell_Product_Model item;
  final int exitflag;
  griditemdetail1(this.item, this.exitflag);
...
//          ),
                ...
                Container(
                  padding: const EdgeInsets.fromLTRB(10.0, 0.0, 10.0, 10.0),
                  child:
                      item.shipping_charge == "" || item.shipping_charge == null
                          ? Text(
                              "Shipping charge  " + "---",
                              style: TextStyle(
                                fontSize: 13.0,
...
//                        onPressed: () => _openAddUserDialog(),
                ...
                Container(
                    ...
                    child: GestureDetector(
                      onTap: () => MyNavigator.gotoWebViewScreen(context,
                          'Item Returns Policy', "threadon.com/return"),
                      child: Text(
                        "LEARN MORE",
                        style: TextStyle(
                            color: Colors.red,
                ...
                Container(
                    ...
                    child: GestureDetector(
                      onTap: () => MyNavigator.gotoWebViewScreen(context,
                          'Help & Support', "threadon.com/helpsupport"),
                      child: Text(
                        "LEARN MORE",
                        style: TextStyle(
                            color: Colors.red,
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                new Container(
                                  ...
                                  child: Text(
                                    similerproductList[position].item_title,
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 1,
                                    style: TextStyle(
                                      fontSize: 14.0,
...
//                  GetRatings(),
                                ...
                                new Container(
                                  ...
                                  child: Text(
                                    "\$" +
                                        similerproductList[position].item_price,
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 14.0,
                                      fontWeight: FontWeight.bold,
...
//                  GetRatings(),
              ...
              onTap: () async {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        GridItemDetails(item: similerproductList[position]),
                  ),
                );
              },
            );
