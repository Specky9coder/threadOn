...
import 'package:threadon/tab_screen/Seller_Completed_Tab.dart';
import 'package:threadon/tab_screen/Seller_Orders_Tab.dart';
import 'package:threadon/utils/my_navigator.dart';
import 'package:flutter/services.dart';


class Lable_screen extends StatefulWidget {
  String appbar_name;


  Lable_screen({Key key, this.appbar_name}) : super(key: key);

  @override
  State<StatefulWidget> createState() => lable_screen(appbar_name);
}

class lable_screen extends State<Lable_screen> with SingleTickerProviderStateMixin  {
  String appbar_name;
...
//        automaticallyImplyLeading: false,
        ...
        body: 
        getTabBarView(<Widget>[new Seller_Orders_Tab(), new Seller_Completed_Order_Tab()]));
